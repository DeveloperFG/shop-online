  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="px-4 py-20">
          <div className="mx-auto max-w-2xl rounded-2xl border border-border bg-card p-8 text-center shadow-sm sm:p-12">
            <h2 className="text-2xl font-bold text-card-foreground sm:text-3xl">Suporte ao cliente</h2>
            <p className="mt-3 text-muted-foreground">Entre em contato com nosso suporte para resolver qualquer dúvida ou problema.</p>
            <Button type="button" size="lg" className="mt-6" onClick={() => setContactOpen(true)}>
